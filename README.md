...
> 채팅하나당 노드를 생성하면 뭔가 될 것 같아 한 번 써보기로 했었다. XML도 보기만하고 이번에 처음 써본 언어라 우여곡절이 많았지만 아무쪼록 성공은 한 듯하다.
...
> 이번을 계기로 새로운 기술이나 라이브러리에 관심이 엄청 생기며 공부하고 싶은 생각이 드는 프로젝트라 의미가 뜻 깊다.
